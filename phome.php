...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $('#calendar').fullCalendar({
        ...
        events: [
            <?php 
             $conferences_list = mysqli_query($conn,"SELECT  distinct * FROM conference confList where confList.therapist_id='".$therapist_id."' and confList.patient_id='".$patient_id."'");
